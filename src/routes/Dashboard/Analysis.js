            ...
            <ChartCard
              ...
              footer={
                <div style={{ whiteSpace: 'nowrap', overflow: 'hidden' }}>
                  ...
                  <Trend flag="down">
                    Ration<span className={styles.trendText}>11%</span>
                  </Trend>
                </div>
              }
              contentHeight={46}
        ...
        <Row gutter={24}>
          <Col xl={12} lg={24} md={24} sm={24} xs={24}>
            ...
            >
              <Row gutter={68}>
                ...
                <Col sm={12} xs={24} style={{ marginBottom: 24 }}>
                  <NumberInfo
                    subTitle="Search frequency per capita"
                    total={2.7}
                    status="down"
                    subTotal={26.2}
                    gap={8}
          ...
          <Col xl={12} lg={24} md={24} sm={24} xs={24}>
            <Card
              ...
              bordered={false}
              title="Accounted Sales Category"
            ...
            >
              ...
              <Pie
                hasLegend
                subTitle="Sales"
                total={money(salesPieData.reduce((pre, now) => now.y + pre, 0))}
                data={salesPieData}
                valueFormat={val => money(val)}
                height={248}
                lineWidth={4}
              />
            </Card>
              ...
              <TabPane tab={<CustomTab data={shop} currentTabKey={activeKey} />} key={shop.name}>
                <div style={{ padding: '0 24px' }}>
                  <TimelineChart
                    ...
                    titleMap={{ y1: 'User traffic', y2: 'Paid User' }}
                  />
                </div>
              </TabPane>
            ))}
